...
import com.example.cvbuilderapplicationassignment6.constants.Constant.IS_LOGGED_IN
import com.example.cvbuilderapplicationassignment6.constants.Constant.SHARED_PREF_NAME
import com.example.cvbuilderapplicationassignment6.constants.Constant.USER_EMAIL
...
class LoginActivity : AppCompatActivity(), OnClickListener {
    ...
    private fun initSharedPreference() {
        ...
        editor.putString(USER_EMAIL, "smislam@miu.edu")
        editor.putString(USER_PASSWORD, "LMSARR1234567")
        editor.putString(USER_NAME, "SM Ershad Ul Islam")
